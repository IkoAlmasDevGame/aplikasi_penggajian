...
<html lang="en">
    ...
    <head>
        ...
        <?php $pagedesc = "Data Gaji Menunggu Approval"; ?>
        ...
        <div class="panel panel-default container-fluid bg-body-secondary rounded-2">
            <div class="panel-heading py-4 container-fluid">
                ...
                <div class="d-flex justify-content-end align-items-end flex-wrap">
                    ...
                    <li class="breadcrumb breadcrumb-item">
                        <a href="?page=gaji_wait&abs=<?= $_GET['abs'] ?>" aria-current="page"
                                    ...
                                    <div class="card-tools my-2">
                                        <div class="text-start">
                                            <h6 class="m-0 font-weight-bold text-primary">
                                                ...
                                                </a> Data Gaji Menunggu Approval Periode
