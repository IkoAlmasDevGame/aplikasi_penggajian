...
<?php
    # error_reporting(0);
    $data = $koneksi->query("SELECT * FROM direktur WHERE id_dir = '$_SESSION[direktur]'");
        ...
        <ul>
            <li class="nav-item dropdown pe-3">
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" role="button"
                    ...
                    <?php if ($baseFile['foto_dir'] != $dir) { ?>
                    <img src="../../../../assets/direktur/<?= $baseFile['foto_dir'] ?>" class="img-responsive rounded-2"
                        style="width: 25px; max-width: 100%;" alt="<?= $baseFile['foto_dir'] ?>">
                    <?php } else { ?>
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    <li class="dropdown-header">
                        ...
                        <div class="text-center">
                            <a href="?page=user-profile&id_dir=<?= $_SESSION['direktur'] ?>"
...
<aside id="sidebar" style="background: rgba(100, 107, 107, 1);" class="sidebar overflow-auto">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <?php if ($baseFile['nama_lengkap'] == $_SESSION['nama']): ?>
        <li class="nav-item">
        ...
        <hr class="border border-top border-light">
        <li class="nav-item">
            <a href="?page=users-data" class="nav-link collapsed" aria-current="page">
                <i class="fa-fw fa fa-users fa-1x"></i>
                <div class="fs-6 display-4 text-dark fw-normal">Data User</div>
            </a>
        </li>
    </ul>
</aside>
