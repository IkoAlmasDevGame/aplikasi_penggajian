...
<?php if ($_SESSION['akses_jabatan'] == 'karyawan'): ?>
    ...
    $data = $koneksi->query("SELECT * FROM karyawan WHERE karyawan.karyawan_id = '$_SESSION[karyawan]' and karyawan.karyawan_status = '$_SESSION[user_stt]'");
                            ...
                            <li class="dropdown-header">
                                ...
                                <h4 class="fs-6 fw-normal text-start text-dark">
                                    <div class="form-inline row justify-content-start align-items-start flex-wrap my-2">
                                        ...
                                        <div class="col-sm-1 col-md-1">:</div>
                                        <div class="col-sm-6 col-md-6">
                                            <?php echo $baseFile['karyawan_status'] ?>
                                        </div>
                                    </div>
                                </h4>
                                <hr class="dropdown-divider my-2">
                                <div class="text-center">
                                    <a href="?page=user-profile&karyawan_id=<?= $_SESSION['karyawan'] ?>"
