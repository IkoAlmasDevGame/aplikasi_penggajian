...
<?php if ($_SESSION['akses_jabatan'] == 'admin') { ?>
    ...
    $data = $koneksi->query("SELECT * FROM karyawan JOIN user ON user.karyawan_id = karyawan.karyawan_id WHERE karyawan.karyawan_id = '$_SESSION[adm]' and user.user_akses = 'Admin HRD' and user.user_stt = 'Aktif'");
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            ...
                            <div class="text-center">
                                <a href="?page=user-profile&karyawan_id=<?= $_SESSION['adm'] ?>"
    ...
    <aside id="sidebar" style="background: rgba(100, 107, 107, 1);" class="sidebar overflow-auto">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <?php if ($baseFile['user_akses'] == 'Admin HRD'): ?>
                <li class="nav-item">
