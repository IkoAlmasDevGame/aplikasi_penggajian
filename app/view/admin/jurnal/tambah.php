...
<head>
    ...
    <?php $pagedesc = "Tambah Data Jurnal"; ?>
                        ...
                        <div class="d-flex justify-content-center align-items-center flex-wrap">
                            <div class="card col-sm-7 col-md-7 shadow">
                                ...
                                <div class="card-body my-2">
                                    <form action="?aksi=jurnal-tambah" enctype="multipart/form-data" method="post"
                                        class="form-group">
                                        <div class="form-inline my-2">
                                            <div class="row justify-content-center align-items-center flex-wrap">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    ...
                                                    $inisial = "TRX";
                                                    $tabel = "jurnal";
                                                    $kode = $jornal->buatKode($tabel, $inisial);
                                                    ?>
                                                    <input type="text" value="<?= $kode ?>" name="trx" id="TRX"
                                                        class="form-control" maxlength="8" readonly required
                                        ...
                                        <div class="form-inline my-2">
                                            <div class="row justify-content-center align-items-center flex-wrap">
                                                ...
                                                <div class="col-sm-1 col-md-1">:</div>
                                                <div class="col-sm-6 col-md-6">
                                                    <input type="text" name="ref" aria-required="TRUE"
                                            ...
                                            <div class="row justify-content-center align-items-start flex-wrap">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <textarea name="ket" class="form-control"
                                                        placeholder="keterangan" id="ket"></textarea>
                                                </div>
                                            </div>
                                        </div>
