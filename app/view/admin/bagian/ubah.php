                        ...
                        <div class="d-flex justify-content-center align-items-center flex-wrap">
                            <div class="card shadow mb-4 col-sm-7 col-md-7">
                                ...
                                <div class="card-body my-2">
                                    <?php if (isset($_GET['bgn'])): ?>
                                        <?php $id = htmlspecialchars($_GET['bgn']); ?>
                                        <?php $SQL = $koneksi->query("SELECT * FROM bagian WHERE bagian_id = '$id'"); ?>
                                        <?php foreach ($SQL as $data): ?>
                                            <form action="?aksi=bagian-ubah" class="form-group" method="post">
                                                <div class="form-inline my-2">
                                                    <div class="row justify-content-end align-items-center flex-wrap">
                                                        <div
                                                            class="form-label col-sm-3 col-md-3 fs-5 text-secondary display-4">
                                                            <label for="no_bagian" class="label label-default">Bagian
                                                                Kode</label>
                                                        </div>
                                                        <div class="col-sm-1 col-md-1">:</div>
                                                        <div class="col-sm-3 col-md-3">
                                                            <input type="text" name="no" id="no_bagian"
                                                                value="<?= $data['bagian_id']; ?>" readonly
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-inline my-2">
                                                    <div class="row justify-content-center align-items-center flex-wrap">
                                                        <div
                                                            class="form-label col-sm-4 col-md-4 fs-5 text-secondary display-4">
                                                            <label for="bagian_nama" class="label label-default">Nama
                                                                Bagian</label>
                                                        </div>
                                                        <div class="col-sm-1 col-md-1">:</div>
                                                        <div class="col-sm-6 col-md-6">
                                                            <input type="text" name="nama" id="bagian_nama"
                                                                value="<?= $data['bagian_nama'] ?>"
                                                    ...
                                                    <div class="row justify-content-center align-items-center flex-wrap">
                                                        ...
                                                        <div class="col-sm-6 col-md-6">
                                                            <input type="text" inputmode="numeric" min="0" name="gaji"
                                                                id="bagian_gaji" value="<?= $data['bagian_gaji'] ?>"
                                                ...
                                                <div class="form-inline my-2">
                                                    <div class="row justify-content-center align-items-center flex-wrap">
                                                        <div
                                                            class="form-label col-sm-4 col-md-4 fs-5 text-secondary display-4">
                                                            <label for="bagian_lembur" class="label label-default">Rate
                                                                Lembur
                                                                /Jam</label>
                                                        </div>
                                                        <div class="col-sm-1 col-md-1">:</div>
                                                        <div class="col-sm-6 col-md-6">
                                                            <input type="text" inputmode="numeric" min="0" name="lembur"
                                                                id="bagian_lembur" value="<?= $data['bagian_lembur'] ?>"
