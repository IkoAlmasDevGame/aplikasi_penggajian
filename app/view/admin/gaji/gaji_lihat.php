                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    <table class="table table-striped-columns table-bordered"
                                                        ...
                                                        <tbody>
                                                            <?php
                                                        $n = 1;
                                                        $sql = "SELECT karyawan.*, bagian.* FROM karyawan, bagian WHERE karyawan.bagian_id=bagian.bagian_id AND karyawan.karyawan_status='Aktif'";
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <a
                                                                        href="?aksi=gaji-input&kry=<?= $data['karyawan_id'] ?>&abs=<?= $abs ?>">
                                                                        <button type="button"
