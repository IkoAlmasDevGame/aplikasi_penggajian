...
<head>
    ...
    <?php $pagedesc = "Tambah Data Tunjangan"; ?>
            ...
            <div class="d-flex justify-content-end align-items-end flex-wrap">
                ...
                <li class="breadcrumb breadcrumb-item">
                    <a href="?page=tunjangan" aria-current="page"
                        class="text-decoration-none text-primary"><?php echo "Data Tunjangan" ?></a>
                </li>
                <li class="breadcrumb breadcrumb-item">
                        ...
                        <div class="d-flex justify-content-center align-items-center flex-wrap">
                            <div class="card col-sm-7 col-md-7 shadow mb-3">
                                ...
                                <div class="card-body my-2">
                                    <form action="?aksi=tunjangan-tambah" method="post" class="form-group">
