    ...
    <div class="panel panel-default container-fluid bg-body-secondary rounded-2">
        <div class="panel-heading py-4 container-fluid">
            ...
            <div class="d-flex justify-content-end align-items-end flex-wrap">
                ...
                <li class="breadcrumb breadcrumb-item">
                    <a href="?aksi=edit-lembur&lem=<?= $_GET['lem'] ?>" aria-current="page"
                        ...
                        <div class="d-flex justify-content-center align-items-center flex-wrap">
                            <div class="card col-sm-7 col-md-7 shadow mb-3">
                                ...
                                <div class="card-body my-2">
                                    <?php if (isset($_GET['lem'])): ?>
                                        <?php $id = htmlspecialchars($_GET['lem']); ?>
                                        <?php $sql = "SELECT * FROM lembur WHERE lembur_id='$id'"; ?>
                                        <?php $ress = $koneksi->query($sql); ?>
                                        <?php foreach ($ress as $data): ?>
                                            <form action="?aksi=lembur-ubah" class="form-group" method="post"
                                                ...
                                                <div class="form-inline my-2">
                                                    <div class="row justify-content-center align-items-center flex-wrap">
                                                        ...
                                                        <div class="col-sm-7 col-md-7">
                                                            ...
                                                            <input type="hidden" value="<?= $data['lembur_id'] ?>"
                                                                name="id">
                                                        </div>
                                                    </div>
                                                </div>
