    ...
    <div class="panel panel-default container-fluid bg-body-secondary rounded-2">
        <div class="panel-heading py-4 container-fluid">
            ...
            <div class="d-flex justify-content-end align-items-end flex-wrap">
                ...
                <li class="breadcrumb breadcrumb-item">
                    <a href="?aksi=edit-akun&akn=<?= $_GET['akn'] ?>" aria-current="page"
                        ...
                        <div class="d-flex justify-content-center align-items-center flex-wrap">
                            <div class="card col-sm-7 col-md-7 shadow">
                                ...
                                <div class="card-body my-2">
                                    <?php if (isset($_GET['akn'])): ?>
                                        <?php $akn = htmlspecialchars($_GET['akn']); ?>
                                        <?php $ress = $akun->akun_edit($akn); ?>
                                        <?php foreach ($ress as $row): ?>
                                            <form action="?aksi=akun-edit" class="form-group" method="post">
                                                <div class="my-2"></div>
                                                <!-- === Kode Akun === -->
                                                <div class="form-inline row justify-content-center 
                                                    ...
                                                    <div class="col-sm-6 col-md-6">
                                                        <input type="text" name="akun_kode" value="<?= $row['akun_kode'] ?>"
                                                            maxlength="20" aria-required="TRUE" class="form-control"
                                                ...
                                                <div class="form-inline row justify-content-center 
                                                    ...
                                                    <div class="col-sm-6 col-md-6">
                                                        <input type="text" name="akun_nama" value="<?= $row['akun_nama'] ?>"
                                                            maxlength="100" aria-required="TRUE" class="form-control"
