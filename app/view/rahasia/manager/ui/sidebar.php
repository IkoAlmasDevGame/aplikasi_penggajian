...
<?php if ($_SESSION['akses_jabatan'] == 'manager'): ?>
    <?php
    # error_reporting(0);
    $data = $koneksi->query("SELECT * FROM manager WHERE id_mng = '$_SESSION[manager]'");
                ...
                <ul>
                    <li class="nav-item dropdown pe-3">
                        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" role="button"
                            ...
                            <?php if ($baseFile['foto_mng'] != $dir) { ?>
                                <img src="../../../../../assets/manager/<?= $baseFile['foto_mng'] ?>"
                                    class="img-responsive rounded-2" style="width: 25px; max-width: 100%;"
                                    alt="<?= $baseFile['foto_mng'] ?>">
                            <?php } else { ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                            <li class="dropdown-header">
                                ...
                                <div class="text-center">
                                    <a href="?page=user-profile&id_mng=<?= $_SESSION['manager'] ?>"
