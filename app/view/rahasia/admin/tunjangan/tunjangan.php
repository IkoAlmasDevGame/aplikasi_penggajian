        ...
        <div class="panel panel-default container-fluid bg-body-secondary rounded-2">
            <div class="panel-heading py-4 container-fluid">
                ...
                <div class="d-flex justify-content-end align-items-end flex-wrap">
                    ...
                    <li class="breadcrumb breadcrumb-item">
                        <a href="?page=tunjangan" aria-current="page"
                                ...
                                <div class="card-body my-2">
                                    <div class="card-tools">
                                        <div class="text-start">
                                            <div class="text-start">
                                                <a href="?aksi=tambah-tunjangan" aria-current="page"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center fw-normal">
                                                                <?php echo format_tanggal($tjg_tgl) ?>
                                                            </td>
                                                            <td class="text-center fw-normal">
                                                                <?php echo format_rupiah($tjg_jml) ?>
                                                            </td>
                                                            <td class="text-start fw-normal">
                                                                <?php echo $tjg_ket ?>
                                                            </td>
                                                            <td class="text-center fw-normal">
                                                                <a href="?aksi=tunjangan-hapus&tjg=<?= $tjg_id ?>"
                                                                    aria-current="page"
                                                                    onclick="return confirm('Apakah anda yakin akan menghapus tunjangan <?php echo $karyawan_nama; ?>?');">
                                                                    <button type="button" class="btn btn-sm btn-danger">
                                                                        <i class="fas fa-fw fa-1x fa-trash"></i>
                                                                    </button>
                                                                </a>
                                                                <a href="?aksi=edit-tunjangan&tjg=<?= $tjg_id ?>"
                                                                    aria-current="page">
                                                                    <button type="button"
