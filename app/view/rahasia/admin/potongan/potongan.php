                                ...
                                <div class="card-body my-2">
                                    <div class="card-tools">
                                        <div class="text-start">
                                            <div class="text-start">
                                                <a href="?aksi=tambah-potongan" aria-current="page"
                                                ...
                                                <table class="table table-striped-columns table-bordered"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center fw-normal">
                                                                <a href="?aksi=potongan-hapus&pot=<?= $pot_id ?>"
                                                                    aria-current="page"
                                                                    onclick="return confirm('Apakah anda yakin akan menghapus potongan <?php echo $karyawan_nama; ?>?');">
                                                                    <button type="button" class="btn btn-sm btn-danger">
                                                                        <i class="fas fa-fw fa-1x fa-trash"></i>
                                                                    </button>
                                                                </a>
                                                                <a href="?aksi=edit-potongan&pot=<?= $pot_id ?>"
                                                                    aria-current="page">
                                                                    <button type="button"
