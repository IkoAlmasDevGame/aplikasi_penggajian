                                                ...
                                                <table class="table table-bordered table-striped-columns"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-start fw-normal" width="5%">Opsi</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php $n = 1; ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center fw-normal">
                                                                <a href="?aksi=akun-hapus&akn=<?= $row['akun_kode'] ?>"
                                                                    aria-current="page"
                                                                    onclick="return confirm('Apakah anda yakin akan menghapus akun <?php echo $row['akun_nama']; ?>?');">
                                                                    <button type="button" class="btn btn-sm btn-danger">
                                                                        <i class="fas fa-fw fa-1x fa-trash"></i>
                                                                    </button>
                                                                </a>
                                                                <a href="?aksi=edit-akun&akn=<?= $row['akun_kode'] ?>"
                                                                    aria-current="page">
                                                                    <button type="button"
