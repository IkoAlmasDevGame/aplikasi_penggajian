                                                        ...
                                                        <?php while ($data = mysqli_fetch_array($ress)) { ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center fw-normal">
                                                                    ...
                                                                    <a href="?aksi=edit-karyawan&kry=<?= $karyawan_id ?>"
                                                                        aria-current="page">
                                                                        <button type="button"
                                                                    ...
                                                                    <a href="?aksi=karyawan-hapus&kry=<?= $karyawan_id ?>"
                                                                    ...
                                                                    <a href="?aksi=karyawan-reset&kry=<?= $karyawan_id ?>"
                                                                        onclick="return confirm('Apakah anda yakin akan mereset password <?php echo $data['karyawan_nama']; ?>?')"
                                                                        aria-current="page">
                                                                        <button type="button"
                                                                            class="btn btn-sm btn-primary rounded-3">
                                                                            <i class="fas fa-recycle fa-1x fa-fw"></i>
                                                                        </button>
                                                                    </a>
                                                                </td>
                                                            </tr>
